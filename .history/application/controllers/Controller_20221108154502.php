...
class Controller extends CI_Controller
{
  ...
  public function registerGuru_process()
  {
    ...
    if ($this->form_validation->run() == true) {
      ...
      <p>Email anda sudah terdaftar.</p>
    </div>');
  ...
  public function Dashboard()
  {
    ...
    if ($this->session->userdata('hakAkses') == 'siswa') {
      ...
      $data['idKelas'] = $this->Kelas->getAllIdKelasSiswa($idSiswa);
      ...
      $data['idKelas'] = $this->Kelas->getAllIdKelasGuru($idSiswa);
      $data['idGuru'] = $idGuru;
  ...
  public function addPertanyaan_process()
  {
    ...
    if ($this->form_validation->run() == true) {
      ...
      //Menyimpan data masukan pengguna dan menampilkan pesan berhasil
      $this->Pertanyaan->addPertanyaan($idGuru, $idKelas, $idSiswa, $deskripsiPertanyaan, $judulMateri, $waktuKirim);
