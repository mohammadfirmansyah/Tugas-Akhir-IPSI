...
class Pertanyaan extends CI_Model
{
  ...
  public function saveKomentarSiswa($idPertanyaan, $idSiswa, $namaSiswa, $deskripsiKomentar, $jenisKomentar, $waktuKirim)
  {
    $data = array(
      "idPertanyaan" => $idPertanyaan,
      "idSiswa" => $idSiswa,
  ...
  public function saveKomentarGuru($idPertanyaan, $idGuru, $namaGuru, $deskripsiKomentar, $jenisKomentar, $waktuKirim)
  {
    $data = array(
      "idPertanyaan" => $idPertanyaan,
      "idGuru" => $idGuru,
