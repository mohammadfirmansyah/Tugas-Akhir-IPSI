    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar" style="margin-right: auto;">
        <ul>
          ...
          <li><a href="<?php echo base_url('guru/' . $idGuru); ?>" class="logo me-auto nav-link" style="margin-left: 30px; margin"><img src="assets/img/profil.png" alt="" class="img-fluid"></a></li>
