    ...
    <div class="card-deck-wrapper">
        ...
        <?php if (empty($List_Kelas) && empty($List_Pertanyaan)) { ?>
          ...
          <?php } else if ((!empty($List_Kelas) && empty($List_Pertanyaan))) { ?>
            ...
            <a style="text-align: center; margin-left: auto; margin-right: auto; display: grid; max-width: 200px;" class="btn-get-started_i mb-5" href="<?php echo base_url('kelasSaya'); ?>">REFRESH</a>
          <?php } else { ?>
