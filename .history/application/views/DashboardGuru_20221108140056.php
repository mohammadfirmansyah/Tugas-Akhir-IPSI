    ...
    <div class="card-deck-wrapper">
        ...
        <?php if (empty($List_Kelas) && empty($List_Pertanyaan)) { ?>
          ...
          <?php } else if ((!empty($List_Kelas) && empty($List_Pertanyaan))) { ?>
            ...
            <h2 style="text-align: center;" class="mb-2">Bagikan kode kelas kepada siswa anda agar mereka bisa memberikan pertanyaan.</h2>
            <h2 style="text-align: center; font-size: 14px;" class="mb-4">Kode kelas berada di halaman detail kelas.</h2>
