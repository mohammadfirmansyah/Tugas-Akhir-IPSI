...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar" style="margin-left: auto;">
        <ul>
          ...
          <li><a href="<?php echo base_url('profilSiswa/' . $idSiswa); ?>" class="logo me-auto nav-link" style="margin-left: 30px;"><img src="assets/img/profil.png" alt="" class="img-fluid"></a></li>
        </ul>
  ...
  <!-- ======= Hero Section ======= -->
  <section style="top: 100px; position: relative;">
  <h3 style="color: #fff; text-align: center; display: list-item;">Dashboard : Daftar semua pertanyaan ada disini!</h3>  
  </section>
  <section id="hero" class="d-flex align-items-center position-absolute">
    <div class="container my-4 pt-4 px-5" style="border-color: #fff; border-style: solid; border-width: 3px; border-radius: 20px; z-index: 1; backdrop-filter: blur(16px);"> 
