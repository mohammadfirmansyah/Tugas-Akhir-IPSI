      ...
      <div class="card-deck-wrapper">
        <div class="card-deck">
          <?php if (empty($List_Kelas) && empty($List_Pertanyaan)) { ?>
            ...
            <a style="text-align: center; margin-left: auto; margin-right: auto; display: grid; max-width: 250px;" class="btn-get-started_h" href="<?php echo base_url('joinKelas'); ?>">GABUNG KELAS +</a>
