      ...
      <div class="card-deck-wrapper">
        <div class="card-deck">
          ...
          <?php } else if ((!empty($List_Kelas))) { ?>
            ...
            <h2 style="text-align: center;" class="mb-4">Kirim pertanyaan ke guru kamu sekarang dengan menekan tombol dibawah ini.</h2>
          ...
          <?php } else { ?>
            <?php foreach ($idKelas as $idKelasSiswa) :
              $List_Pertanyaan = $this->Pertanyaan->getAllPertanyaanSiswa($idKelasSiswa->idKelas);
            ?>
