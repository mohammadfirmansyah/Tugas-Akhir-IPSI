            ...
            <div class="card-body p-5 text-center">
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('addPertanyaan_process'); ?>" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="mataPelajaran" name="judulMateri" class="form-control form-control-lg" placeholder="Judul Materi*" style="background: #224957; border-color: #224957; color: #fff;" />
                </div>
                <div class="form-outline mb-4">
