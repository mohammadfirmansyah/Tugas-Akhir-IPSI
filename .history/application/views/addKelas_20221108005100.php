        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card" style="background: transparent; border-color: transparent;" data-aos="fade-up" data-aos-delay="200">
            <div class="card-body p-5 text-center">
              <h1 class="pb-3">Tambah</h1>
              <h1 class="pb-3">Kelas Baru</h1>
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('addPertanyaan_process'); ?>" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="mataPelajaran" name="mataPelajaran" class="form-control form-control-lg" placeholder="Judul Materi*" style="background: #224957; border-color: #224957; color: #fff;" />
                </div>
                <div class="form-outline mb-4">
                  <textarea id="deskripsiKelas" name="deskripsiPertanyaan" class="form-control form-control-lg" placeholder="Deskripsi Pertanyaan*" style="background: #224957; border-color: #224957; color: #fff; min-height: 200px; resize: none;"></textarea>
                </div>
                <button class="btn-get-started_b btn-lg btn-block" type="submit" style="border-radius: 10px; width: 100%; height: 60px; text-align: center; line-height : 35px; border-color: transparent;">Masuk</button>
              </form>
            </div>
          </div>
        </div>
