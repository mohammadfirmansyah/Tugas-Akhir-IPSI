            ...
            <div class="card-body p-5 text-center">
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('addPertanyaan_process'); ?>" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="mataPelajaran" name="mataPelajaran" class="form-control form-control-lg" placeholder="Mata Pelajaran*" style="background: #224957; border-color: #224957; color: #fff;" />
                </div>
                <div class="form-outline mb-4">
                  <textarea id="deskripsiKelas" name="deskripsiKelas" class="form-control form-control-lg" placeholder="Deskripsi Pertanyaan*" style="background: #224957; border-color: #224957; color: #fff; min-height: 200px; resize: none;"></textarea>
                </div>
