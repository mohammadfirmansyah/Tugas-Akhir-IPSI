        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card" style="background: transparent; border-color: transparent;" data-aos="fade-up" data-aos-delay="200">
            <div class="card-body p-5 text-center">
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('addKelas'); ?>" method="post">
                ...
                <button class="btn-get-started_a btn-lg btn-block" type="submit" style="border-radius: 10px; width: 100%; height: 60px; text-align: center; line-height : 35px; border-color: transparent;">Masuk</button>
              </form>
            </div>
          </div>
        </div>
