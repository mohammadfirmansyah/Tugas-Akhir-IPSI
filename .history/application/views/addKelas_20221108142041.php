  ...
  <header id="header" class="fixed-top ">
    ...
    <nav id="navbar" class="navbar" style="margin-right: auto;">
        <ul>
          ...
          <><a class="nav-link scrollto active" href="<?php echo base_url('kelasSaya'); ?>"><span>Kelas Saya</span></a>
</ul>
      </nav>
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card" style="background: transparent; border-color: transparent;" data-aos="fade-up" data-aos-delay="200">
            <div class="card-body p-5 text-center">
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('addKelas_process'); ?>" method="post">
