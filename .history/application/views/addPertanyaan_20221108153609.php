                  ...
                  <select id="idGuru" name="idGuru" class="form-control form-control-lg" style="background: #224957; border-color: #224957; color: #fff;">
                    ...
                    foreach ($List_Kelas as $rowIdKelas) :
                      ...
                      foreach ($Detail_Kelas as $rowGuru) : ?>
                        <option value="<?php echo $rowGuru->idGuru; ?>"><?php echo $rowGuru->namaGuru; ?> (<?php echo $rowGuru->mataPelajaran; ?>)
                      <input type="hidden" id="idKelas" name="idKelas" value="<?php echo $rowGuru->namaGuru; ?>">
                      </option>
                    <?php
                      endforeach;
                    endforeach; ?>
