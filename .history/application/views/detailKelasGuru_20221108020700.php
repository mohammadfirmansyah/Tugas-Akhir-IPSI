          ...
          foreach ($Data_Kelas as $rowData) : ?>
            <div class="card p-4 mb-4" style="border-radius: 15px;">
              ...
              <span style="float:right; font-size: 18px;">
                  <a href="<?php echo base_url('editDetailKelas/'. $rowData->idKelas); ?>" class="card-text"><small class="text-muted">Edit Detail Kelas</small><button type="submit" onclick="copyKodeKelas()" style="background: transparent; border: 0px;"><img src="<?php echo base_url(); ?>assets/img/salin.png"></button></a>
                </span>
            </h4>
