              ...
              foreach ($Anggota_Kelas as $rowAnggota) : ?>
                <div class="d-flex justify-content-center justify-content-lg-start">
                  <a href="<?php echo base_url('profilSiswa/' . $rowAnggota->idSiswa); ?>" class="btn-get-started_c" style="border-radius: 15px; min-width: 500px; height: 60px; text-align: left; line-height : 37.5px;"><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid imghov" style="height: 75%;  margin-right: 10px;"><?php echo $rowAnggota->namaSiswa ?>
                    <span style="float:right; font-size: 18px;">
                      <form action="<?php echo base_url('hapus/'. $idKelas .'/'. $rowAnggota->idSiswa); ?>">
                        <a href="<?php echo base_url('hapus/'. $idKelas .'/'. $rowAnggota->idSiswa); ?>" class="btn-get-started_c" style="border-radius: 15px; min-width: 500px; height: 60px; text-align: left; line-height : 37.5px;"><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid imghov" style="height: 75%;  margin-right: 10px;"></a></a>
                  </form>
                  </span>
                  </a>
                </div>
