...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container my-4 pt-4 px-5" style="border-color: #fff; border-style: solid; border-width: 3px; border-radius: 20px; z-index: 1; backdrop-filter: blur(16px); background-color: #fff;">
      <div class="card-deck-wrapper" style="border: 0px;">
        <div class="card-deck" style="border: 0px;">
          <?php
