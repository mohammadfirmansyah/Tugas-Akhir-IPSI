        ...
        <div class="card-deck">
          ...
          foreach ($Data_Kelas as $rowData) : ?>
            <div class="card p-4 mb-4" style="border-radius: 15px;">
              ...
              <h4 class="card-title" id="kodeKelas" style="color: #000; font-size: 20px;">Kode Kelas &ensp;:&nbsp;&nbsp;<?php echo $rowData->kodeKelas; ?><button type="submit" onclick="copyKodeKelas()" style="background: transparent; border: 0px;"><img src="<?php echo base_url(); ?>assets/img/salin.png"></button></h4>
