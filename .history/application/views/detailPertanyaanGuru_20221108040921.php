        ...
        <div class="card-deck">
          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <?php } else { ?>
              ...
              <?php if ($this->session->flashdata('error')) { ?>
                <?php echo $this->session->flashdata('error'); } ?>  
              <button class="btn-get-started_d btn-lg btn-block mb-4" type="submit" style="border-radius: 10px; width: 300px; height: 50px; text-align: center; line-height : 35px; border-color: transparent;">BERIKAN JAWABAN +</button>
