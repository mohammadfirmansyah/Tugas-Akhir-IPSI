          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <?php if (!empty($Data_Jawaban)) { ?>
              ...
              <div class="p-3 mb-4" style="border-radius: 15px; min-width: 500px; text-align: left; background: #D9D9D9; margin-left: 10vw;">
                <a class="card-title" style="font-size: 30px; margin: 0px; color: #000;" href="<?php echo base_url('siswa/'. $rowkomentar->idGuru); ?>"><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;">Anonim</a>
                <hr>
