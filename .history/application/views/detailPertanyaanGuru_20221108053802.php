    ...
    <div class="card-deck-wrapper">
        <div class="card-deck">
          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            <a class="card-title mb-4" style="color: #000; font-size: 30px;" href=""><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;"><?php echo $this->Pengguna->getNamaSiswa($rowPertanyaan->idSiswa)?></a>
            ...
            <?php if (!empty($Data_Jawaban)) { ?>
              ...
              <div class="p-3 mb-4" style="border-radius: 15px; min-width: 500px; text-align: left; background: #D9D9D9;">
                <a class="card-title" style="font-size: 30px; margin: 0px;" href="<?php echo base_url('guru/'. $rowJawaban->idGuru); ?>"><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;"><?php echo $rowJawaban->namaGuru; ?></a>
                <hr>
              ...
              <div class="p-3 mb-4" style="border-radius: 15px; min-width: 500px; text-align: left; background: #D9D9D9; margin-left: 10vw;">
                <a class="card-title" style="font-size: 30px; margin: 0px; color: #000;" href="<?php echo base_url('siswa/'. $rowKomentar->idAlias); ?>"><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;"><?php echo $this->Pengguna->getNamaSiswa($rowKomentar->idAlias)?></a>
                <hr>
                <h3 class="card-text mb-4" style="color: #000;"><?php echo $rowKomentar->deskripsiKomentar; ?></h3>
              </div>
              <?php } else { ?>
                <div class="p-3 mb-4" style="border-radius: 15px; min-width: 500px; text-align: left; background: #D9D9D9; margin-left: 10vw;">
                <a class="card-title" style="font-size: 30px; margin: 0px;" href="<?php echo base_url('guru/'. $rowKomentar->idAlias); ?>"><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;"><?php echo $rowKomentar->namaAlias; ?></a>
                <hr>
                <h3 class="card-text mb-4" style="color: #000;"><?php echo $rowKomentar->deskripsiKomentar; ?></h3>
              </div>
                <?php } ?>
