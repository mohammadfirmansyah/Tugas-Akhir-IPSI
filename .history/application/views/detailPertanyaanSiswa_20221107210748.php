...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container my-4 pt-4 px-5" style="border-color: #fff; border-style: solid; border-width: 3px; border-radius: 20px; z-index: 1; backdrop-filter: blur(16px); background-color: trans;">
      <div class="card-deck-wrapper">
        <div class="card-deck">
          <?php
          // foreach ($Data_Pertanyaan as $rowData) : ?>
            <div class="card p-4 mb-4" style="border-radius: 15px;">
              <h2 class="card-title mb-4" style="color: #000;">Nama Siswa</h2>
              <h4 class="card-title mb-4" style="color: #000; font-size: 20px;">Nama Guru &nbsp;:</h4>
              <hr>
              <p class="card-text mb-4" style="color: #808080;"></p>
