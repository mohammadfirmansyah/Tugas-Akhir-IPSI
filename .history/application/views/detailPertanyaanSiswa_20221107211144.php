        ...
        <div class="card-deck">
          ...
          // foreach ($Data_Pertanyaan as $rowData) : ?>
            <div class="card p-4 mb-4" style="border-radius: 15px;">
              <a class="card-title mb-4" style="color: #000; font-size: 30px;"><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid imghov" style="height: 100%;  margin-right: 10px;">Anonim</a>
