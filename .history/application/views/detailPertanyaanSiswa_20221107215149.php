        ...
        <div class="card-deck">
          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <?php if (!empty($Data_Jawaban)) { ?>
              ...
              <textarea name="deskripsiKomentar" id="deskripsiKomentar" class="form-control form-control-lg" style="background: #D9D9D9; border-color: #224957; color: #fff; min-height: 200px; resize: none;"></textarea>
            <?php } else { ?>
