          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <?php if (!empty($Data_Jawaban)) { ?>
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('addKomentar_process'); ?>" method="post">
                ...
                <textarea name="deskripsiKomentar" id="deskripsiKomentar" class="form-control form-control-lg" style="background: #D9D9D9; border-color: #224957; color: #000; resize: none; ::placeholder" placeholder="Komentar anda"></textarea>
              </form>
            <?php } else { ?>
