          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <?php if (!empty($Data_Jawaban)) { ?>
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('addKomentar_process'); ?>" method="post">
                <button class="btn-get-started_d btn-lg btn-block" type="submit" style="border-radius: 10px; width: 300px; height: 50px; text-align: center; line-height : 30px; border-color: transparent;">TAMBAH KOMENTAR +</button>
                <textarea name="deskripsiKomentar" id="deskripsiKomentar" class="form-control form-control-lg" style="background: #D9D9D9; border-color: #224957; color: #000; resize: none; ::placeholder: c" placeholder="Komentar anda"></textarea>
              </form>
            <?php } else { ?>
