          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <?php if (!empty($Data_Jawaban)) { ?>
              ...
              <div class="p-3" style="border-radius: 15px; min-width: 500px; text-align: left; background: #D9D9D9;">
                <a class="card-title btn-get-started_c" style="font-size: 30px; margin: 0px;" href=""><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;"><?php echo $rowPertanyaan->judulMateri; ?></a>
                <hr>
