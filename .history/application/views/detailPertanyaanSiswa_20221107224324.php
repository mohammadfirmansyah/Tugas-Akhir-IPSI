      ...
      <div class="card-deck-wrapper">
        <div class="card-deck">
          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <h4 class="card-title mb-4" style="color: #000; font-size: 20px;"><?php echo $rowPertanyaan->waktuKirim; ?> - <b><?php echo $rowPertanyaan->judulMateri; ?></b></h4>
            <hr>
            ...
            <?php if (!empty($Data_Jawaban)) { ?>
              ...
              <div class="p-3 mb-4" style="border-radius: 15px; min-width: 500px; text-align: left; background: #D9D9D9; margin-left: 10vw;">
                <a class="card-title" style="font-size: 30px; margin: 0px;" href=""><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;">Anonim</a>
                <hr>
              ...
              <?php } else { ?>
                ...
                <?php } ?>
                <?php endforeach; ?>
              <form enctype="multipart/form-data" action="<?php echo base_url('sendKomentar_process'); ?>" method="post">
