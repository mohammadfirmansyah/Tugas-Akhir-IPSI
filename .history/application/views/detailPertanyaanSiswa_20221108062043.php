        ...
        <div class="card-deck">
          ...
          ?>
            <div class="card p-4 mb-4" style="border-radius: 15px;">
              ...
              <?php } else { ?>
                <a class="card-title mb-4" style="font-size: 30px;" href=""><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;">Anonim</a>
              <?php } ?>
