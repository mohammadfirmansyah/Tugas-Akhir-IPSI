                ...
                <?php foreach ($Data_Komentar as $rowKomentar) : ?>
                  <?php if ($rowKomentar->jenisKomentar == "siswa" && $rowKomentar->idAlias == $idSiswa) { ?>
                    <div class="p-3 mb-4" style="border-radius: 15px; min-width: 500px; text-align: left; background: #BAE4F4; margin-left: 10vw;">
                      <a class="card-title" style="font-size: 30px; margin: 0px; color: #000;" href=""><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;">Saya</a>
                      <hr>
