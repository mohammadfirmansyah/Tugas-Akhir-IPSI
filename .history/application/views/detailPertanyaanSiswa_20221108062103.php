              ...
              <?php if (!empty($Data_Jawaban)) { ?>
                ...
                <?php foreach ($Data_Komentar as $rowKomentar) : ?>
                  ...
                  <?php } else if ($rowKomentar->jenisKomentar == "siswa" && $rowKomentar->idSiswa != $idSiswa) { ?>
                    <div class="p-3 mb-4" style="border-radius: 15px; min-width: 500px; text-align: left; background: #BAE4F4; margin-left: 10vw;">
                      <a class="card-title btn-get-started_c" style="font-size: 30px; margin: 0px;" href="<?php echo base_url('guru/' . $rowKomentar->idAlias); ?>"><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;">Anonim</a>
                      <hr>
                      <h3 class="card-text mb-4" style="color: #000;"><?php echo $rowKomentar->deskripsiKomentar; ?></h3>
                    </div>
                  <?php } else { ?>
