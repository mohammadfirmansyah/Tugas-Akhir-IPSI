            ...
            <div class="card-body p-5 text-center">
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('saveDetail/'.$Data_Kelas->idKelas); ?>" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="text" id="mataPelajaran" name="mataPelajaran" class="form-control form-control-lg" placeholder="Mata Pelajaran*" style="background: #224957; border-color: #224957; color: #fff;" value="<?php echo $Data_Kelas->idKelas ?>" />
                </div>
                <div class="form-outline mb-4">
