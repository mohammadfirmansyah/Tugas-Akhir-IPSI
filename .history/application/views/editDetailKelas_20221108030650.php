          ...
          <div class="card" style="background: transparent; border-color: transparent;" data-aos="fade-up" data-aos-delay="200">
            <div class="card-body p-5 text-center">
              ...
              <form enctype="multipart/form-data" action="<?php echo base_url('saveDetail/'.$Data_Kelas->idKelas); ?>" method="post">
                ...
                <div class="form-outline mb-4">
                  <textarea id="deskripsiKelas" name="deskripsiKelas" class="form-control form-control-lg" placeholder="Deskripsi Kelas*" style="background: #224957; border-color: #224957; color: #fff; min-height: 200px; resize: none;" val></textarea>
                </div>
