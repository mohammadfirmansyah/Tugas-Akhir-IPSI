        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card" style="background: transparent; border-color: transparent;" data-aos="fade-up" data-aos-delay="200">
            <div class="card-body p-5 text-center">
              ...
              <input type="hidden" class="form-control" id="idBerita" name="idBerita" value="<?= $Data_Kelas->idKelas ?>">
                ...
                <div class="form-outline mb-4">
                  <textarea id="deskripsiKelas" name="deskripsiKelas" class="form-control form-control-lg" placeholder="Deskripsi Kelas*" style="background: #224957; border-color: #224957; color: #fff; min-height: 200px; resize: none;"><?= $Data_Kelas->deskripsiKelas ?></textarea>
                </div>
                <button class="btn-get-started_a btn-lg btn-block" type="submit" style="border-radius: 10px; width: 100%; height: 60px; text-align: center; line-height : 35px; border-color: transparent;">Simpan Perubahan</button>
              </form>
            </div>
          </div>
        </div>
