    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar" style="margin-right: auto;">
        <ul>
          ...
          <li><a href="<?php echo base_url('say); ?>" class="logo me-auto nav-link" style="margin-left: 30px;"><img src="assets/img/profil.png" alt="" class="img-fluid"></a></li>
        ...
        <div class="card-deck">
          ...
          ?>
            <li>
              ...
              <h2 style="text-align: center;">Tambahkan kelas baru dengan menekan Tambah Kelas + yang terdapat di atas halaman.</h2>
            </li>
          <?php } ?>
        </div>
      </div>
