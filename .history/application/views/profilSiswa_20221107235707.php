    ...
    <div class="card-deck-wrapper">
        <div class="card-deck">
          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            <a class="card-title mb-4" style="color: #000; font-size: 30px;" href=""><img src="<?php echo base_url(); ?>assets/img/profil-black.png" class="img-fluid" style="display: flexbox; height: 40px;  margin-right: 10px;"></a>
            <h4 class="card-title mb-4" style="color: #000; font-size: 20px;"></h4>
            <hr>
            <h3 class="card-text mb-4" style="color: #000;"></h3>
            <h4 class="card-title mb-4" style="color: #000; font-size: 20px;"></h4>
          </div>
          <?php
          endforeach; 
