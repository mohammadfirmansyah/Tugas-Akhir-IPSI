    ...
    <div class="card-deck-wrapper">
        <div class="card-deck">
          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <a style="color: #D9542A; font-size: 24px; margin-top: 50px;">Logout <img src="<?php echo base_url(); ?>assets/img/exit.png" class="img-fluid" style="display: flexbox; height: 24px;  margin-left: 10px;"></a>
          </div>
          <?php
          endforeach; 
          ?>
