    ...
    <div class="card-deck-wrapper">
        <div class="card-deck">
          ...
          <div class="card p-4 mb-4" style="border-radius: 15px;">
            ...
            <a href="<?php echo base_url('Logout_process'); ?>" style="color: #D9542A; font-size: 24px; text-align: right;" class="">Logout <img src="<?php echo base_url(); ?>assets/img/exit.png" class="img-fluid" style="display: flexbox; height: 24px;  margin-left: 10px;"></a>
          </div>
          <?php
          endforeach; 
          ?>
