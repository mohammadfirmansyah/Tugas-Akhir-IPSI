        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card" style="background: transparent; border-color: transparent;" data-aos="fade-up" data-aos-delay="200">
            <div class="card-body p-5 text-center">
              <h1 class="pb-3">MASUK</h1>
              <h2 class="pb-1" style="font-size: 15px;">Masuk dan berikan pertanyaan seputar pelajaran di sekolah!</h2>
              <form enctype="multipart/form-data" action="<?php echo base_url('Login_process'); ?>" method="post">
                <?php if ($this->session->flashdata('error')) { ?>
                <?php echo $this->session->flashdata('error');
                } ?>
                <div class="form-outline mb-4">
                  <input type="text" id="email" name="email" class="form-control form-control-lg" placeholder="Email*" style="background: #224957; border-color: #224957; color: #fff;" />
                </div>
                <div class="form-outline mb-4">
