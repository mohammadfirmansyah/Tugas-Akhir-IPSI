        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card" style="background: transparent; border-color: transparent;" data-aos="fade-up" data-aos-delay="200">
            <div class="card-body p-5 text-center">
              ...
              <h1 class="pb-5">SISWA</h1>
              <form enctype="multipart/form-data" action="<?php echo base_url('registerSiswa_process'); ?>" method="post">
                ...
                <div class="form-outline mb-4">
                  <input type="text" maxlength="10"  id="nisn" name="nisn" class="form-control form-control-lg" placeholder="NISN*" style="background: #224957; border-color: #224957; color: #fff;" />
                </div>
                <div class="form-outline mb-4">
